...
The goal of regexcitejacq is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcitejacq from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("Jacq4nn/regexcitejacq")
```
...
That’s exactly what `regexcitejacq::str_split_one()` does.

``` r
library(regexcitejacq)
